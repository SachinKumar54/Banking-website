<?php
   ...
   if(isset($_POST['bsubmit'])){
      ...
      $pswd = md5($_POST['bpassword']);
      $utype= 'banker';
      $select = " SELECT * FROM users WHERE  username = '$username' && pswd = '$pswd' && utype = '$utype'";
   ...
   <body>
      <section class="reg_section">
         <div class="registration_card">
            <h4 class="heading_h4">Banker Sign In</h4>
            <form method="post">
               <div class="form-row"> 
                  <?php
                     if(isset($error)){
               ...
               <div class="form-row"> <input type="text" class="form-controll" name="busername" placeholder="Username"> </div>
               <div class="form-row"> <input type="password" class="form-controll" name="bpassword" placeholder="Password"> </div>
               <div class="form-row row reg_links">
                  <div class="col-lg-6" style="text-align: left;">
                     <a href="Register.php" class="text-primary">Create Account?</a>
                  </div>
               </div>
               <div class="form-row"> <input type="submit"value="submit" name="bsubmit" class="home-btn reg_btn"> </div>
            </form>
         </div>
      </section>
      <!--- Bootstrap JS -->
